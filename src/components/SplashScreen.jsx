    ...
    >
      <div className="relative flex items-center justify-center">
        ...
        <motion.img
          ...
          alt="WonderKids"
          className="h-28 sm:h-40 md:h-48 w-auto drop-shadow-xl relative z-10"
      ...
      <motion.button
        className="mt-5 px-8 py-3 bg-gradient-to-r from-pink-400 to-purple-500 text-white font-bold rounded-full text-lg shadow-lg active:scale-95 transition-transform"
